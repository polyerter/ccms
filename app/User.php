...
class User extends Authenticatable
{
	 ...
	 */
	protected $fillable = [
		'name', 'password', 'email', 'familiya', 'imya', 'otchestvo', 'phone', 'birthday', 'housing', 'city', 'numberdoc', 'datesoc', 'datepayhous', 'role',
	];
...
//
	...
	{
		return $this->belongsToMany(\App\Permission::class, 'permission_user', 'user_id', 'permission_id');
	}
