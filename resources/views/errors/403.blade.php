...
@section('error')
  ...
  <h4 class="xp-error-subtitle text-black m-b-30"><i class="mdi mdi-emoticon-sad text-danger font-32"></i>Упс! Доступ запрещен</h4>
  <p class="text-muted m-b-30">Вам запрещено посещать данную страницу</p>
