          ...
          <div class="card-body">
            ...
            @include('admin.layouts.bodyerrors')
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input type="text" class="form-control" id="val-fam" name="familiya" placeholder="Введите фамилию пайщика.." value="{{ $users->familiya }}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-name">Имя <span class="text-danger">*</span></label>
                <div class="col-lg-9">
                  <input type="text" class="form-control" id="val-name" name="imya" placeholder="Введите имя пайщика.." value="{{ $users->imya }}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-otch">Отчество </label>
                <div class="col-lg-9">
                  <input type="text" class="form-control" id="val-otch" name="otchestvo" placeholder="Введите отчество пайщика.." value="{{ $users->otchestvo }}">
                </div>
              </div>
            <div class="form-group row">
              <label class="col-lg-3 col-form-label" for="val-email">Логин </label>
              <div class="col-lg-9 input-group">
                <input type="text" name="name" id="mail-pay" class="form-control" placeholder="" aria-label="Recipient's username" aria-describedby="basic-addon2" readonly="" value="{{ $users->name }}">
              </div>
            </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-email">Email </label>
                <div class="col-lg-9 input-group">
                  <input type="text" name="email" id="mail-pay" class="form-control" placeholder="" aria-label="Recipient's username" aria-describedby="basic-addon2" value="{{ $users->email }}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-password">Пароль </label>
                <div class="col-lg-9 input-group">
                  <input type="text" id="pass" name="password" class="form-control" placeholder="Пароль" aria-label="Пароль" aria-describedby="button-addon2"  >
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  <input type="text" class="form-control" id="xp-inputmask-phone" name="phone" placeholder="+7 (___) ___-__-__" value="{{ $users->phone }}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-currency">Дата рождения <span class="text-danger">*</span></label>
                <div class="input-group col-lg-9">
                  <input type="text" id="xp-default-date" class="datepicker-here form-control" name="birthday" aria-describedby="basic-addon2" value="{{ $users->birthday }}"/>
                  <div class="input-group-append">
      ...
      <div class="col-lg-6">
        <div class="card m-b-30">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-username">Стоимость жилья <span class="text-danger">*</span></label>
                <div class="col-lg-9">
                  <input type="text" class="form-control" id="val-username" name="housing" placeholder="Примерная стоимость жилья" value="{{ $users->housing }}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-username">Откуда (Город) </label>
                <div class="col-lg-9">
                  <input type="text" class="form-control" id="val-username" name="city" placeholder="Город" value="{{ $users->city }}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-username">Договор № <span class="text-danger">*</span></label>
                <div class="col-lg-9">
                  <input type="text" class="form-control" id="xp-inputmask-dogovor" name="numberdoc" placeholder="___-__/__-____" value="{{ $users->numberdoc }}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-lg-3 col-form-label" for="val-currency">Дата договора <span class="text-danger">*</span></label>
                <div class="input-group col-lg-9">
                  <input type="text" id="xp-default-date" class="datepicker-here form-control" name="datesoc" placeholder="дд.мм.гггг" aria-describedby="basic-addon2" value="{{ $users->datesoc }}"/>
                  <div class="input-group-append">
                    <span class="input-group-text" id="basic-addon2"><i class="mdi mdi-calendar"></i></span>
                  </div>
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="input-group col-lg-9">
                  <input type="text" id="xp-default-date" class="datepicker-here form-control" name="datepayhous" placeholder="дд.мм.гггг" aria-describedby="basic-addon2" value="{{ $users->datepayhous }}"/>
                  <div class="input-group-append">
                    <span class="input-group-text" id="basic-addon2"><i class="mdi mdi-calendar"></i></span>
                  </div>
                </div>
