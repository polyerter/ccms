!function($) {
	...
	/* Colored Switches */
	var elems = Array.prototype.slice.call(document.querySelectorAll('.js-switch-primary'));

	elems.forEach(function(html) {
		var switchery = new Switchery(html, { color: '#4c7cf3' });
	});
	/*
	var primary = document.getElementsByClassName('.js-switch-primary');
	var switchery = new Switchery(primary, { color: '#4c7cf3' });

	var secondary = document.querySelector('.js-switch-secondary');
	var switchery = new Switchery(secondary, { color: '#4c7cf3' });

	var success = document.querySelector('.js-switch-success');
	var switchery = new Switchery(success, { color: '#4c7cf3' });
 */
